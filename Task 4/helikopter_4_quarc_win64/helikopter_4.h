 ...
 */
#ifndef RTW_HEADER_helikopter_4_h_
#define RTW_HEADER_helikopter_4_h_
#include <math.h>
#include <string.h>
#ifndef helikopter_4_COMMON_INCLUDES_
# define helikopter_4_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* helikopter_4_COMMON_INCLUDES_ */

#include "helikopter_4_types.h"
...
#define helikopter_4_rtModel           RT_MODEL_helikopter_4_T
...
#define rtB                            helikopter_4_B
#define BlockIO                        B_helikopter_4_T
#define rtX                            helikopter_4_X
#define ContinuousStates               X_helikopter_4_T
#define rtXdot                         helikopter_4_XDot
#define StateDerivatives               XDot_helikopter_4_T
#define tXdis                          helikopter_4_XDis
#define StateDisabled                  XDis_helikopter_4_T
#define rtP                            helikopter_4_P
#define Parameters                     P_helikopter_4_T
#define rtDWork                        helikopter_4_DW
#define D_Work                         DW_helikopter_4_T
...
extern P_helikopter_4_T helikopter_4_P;

/* Block signals (auto storage) */
extern B_helikopter_4_T helikopter_4_B;

/* Continuous states (auto storage) */
extern X_helikopter_4_T helikopter_4_X;

/* Block states (auto storage) */
extern DW_helikopter_4_T helikopter_4_DW;

/* Model entry point functions */
extern void helikopter_4_initialize(void);
extern void helikopter_4_output(void);
extern void helikopter_4_update(void);
extern void helikopter_4_terminate(void);

/* Real-time Model object */
extern RT_MODEL_helikopter_4_T *const helikopter_4_M;
 ...
 *
 * '<Root>' : 'helikopter_4'
 * '<S1>'   : 'helikopter_4/Conversion'
 * '<S2>'   : 'helikopter_4/Degrees to Radians'
 * '<S3>'   : 'helikopter_4/Degrees to Radians1'
 * '<S4>'   : 'helikopter_4/Elevation controller'
 * '<S5>'   : 'helikopter_4/Helicopter_interface'
 * '<S6>'   : 'helikopter_4/Pitch controller'
 * '<S7>'   : 'helikopter_4/Helicopter_interface/Elevation rad to deg'
 * '<S8>'   : 'helikopter_4/Helicopter_interface/Elevation rate rad to deg'
 * '<S9>'   : 'helikopter_4/Helicopter_interface/Pitch rad to deg'
 * '<S10>'  : 'helikopter_4/Helicopter_interface/Pitch rate rad to deg'
 * '<S11>'  : 'helikopter_4/Helicopter_interface/Pitch rate rad to deg1'
 * '<S12>'  : 'helikopter_4/Helicopter_interface/Travel rad to deg'
 * '<S13>'  : 'helikopter_4/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helikopter_4_h_ */
