 ...
 */
#ifndef RTW_HEADER_helikopter_3_h_
#define RTW_HEADER_helikopter_3_h_
#include <math.h>
#include <string.h>
#ifndef helikopter_3_COMMON_INCLUDES_
# define helikopter_3_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* helikopter_3_COMMON_INCLUDES_ */

#include "helikopter_3_types.h"
...
#define helikopter_3_rtModel           RT_MODEL_helikopter_3_T
...
#define rtB                            helikopter_3_B
#define BlockIO                        B_helikopter_3_T
#define rtX                            helikopter_3_X
#define ContinuousStates               X_helikopter_3_T
#define rtXdot                         helikopter_3_XDot
#define StateDerivatives               XDot_helikopter_3_T
#define tXdis                          helikopter_3_XDis
#define StateDisabled                  XDis_helikopter_3_T
#define rtP                            helikopter_3_P
#define Parameters                     P_helikopter_3_T
#define rtDWork                        helikopter_3_DW
#define D_Work                         DW_helikopter_3_T

/* Parameters (auto storage) */
struct P_helikopter_3_T_ {
...
extern P_helikopter_3_T helikopter_3_P;

/* Block signals (auto storage) */
extern B_helikopter_3_T helikopter_3_B;

/* Continuous states (auto storage) */
extern X_helikopter_3_T helikopter_3_X;

/* Block states (auto storage) */
extern DW_helikopter_3_T helikopter_3_DW;

/* Model entry point functions */
extern void helikopter_3_initialize(void);
extern void helikopter_3_output(void);
extern void helikopter_3_update(void);
extern void helikopter_3_terminate(void);

/* Real-time Model object */
extern RT_MODEL_helikopter_3_T *const helikopter_3_M;
 ...
 *
 * '<Root>' : 'helikopter_3'
 * '<S1>'   : 'helikopter_3/Conversion'
 * '<S2>'   : 'helikopter_3/Degrees to Radians'
 * '<S3>'   : 'helikopter_3/Degrees to Radians1'
 * '<S4>'   : 'helikopter_3/Elevation controller'
 * '<S5>'   : 'helikopter_3/Helicopter_interface'
 * '<S6>'   : 'helikopter_3/Pitch controller'
 * '<S7>'   : 'helikopter_3/Helicopter_interface/Elevation rad to deg'
 * '<S8>'   : 'helikopter_3/Helicopter_interface/Elevation rate rad to deg'
 * '<S9>'   : 'helikopter_3/Helicopter_interface/Pitch rad to deg'
 * '<S10>'  : 'helikopter_3/Helicopter_interface/Pitch rate rad to deg'
 * '<S11>'  : 'helikopter_3/Helicopter_interface/Pitch rate rad to deg1'
 * '<S12>'  : 'helikopter_3/Helicopter_interface/Travel rad to deg'
 * '<S13>'  : 'helikopter_3/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helikopter_3_h_ */
