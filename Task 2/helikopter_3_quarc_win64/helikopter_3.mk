...
MODEL                = helikopter_3
MODULES              = helikopter_3_data.c helikopter_3_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = helikopter_3.mk
...
MODELLIB                  = helikopter_3lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = helikopter_3_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\helikopter_3_quarc_win64
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);E:\HELILA~2\TASK3~1
