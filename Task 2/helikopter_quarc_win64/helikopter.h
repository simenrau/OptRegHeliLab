...
#define helikopter_rtModel             RT_MODEL_helikopter_T
...
#define BlockIO                        B_helikopter_T
#define rtX                            helikopter_X
#define ContinuousStates               X_helikopter_T
#define rtXdot                         helikopter_XDot
#define StateDerivatives               XDot_helikopter_T
#define tXdis                          helikopter_XDis
#define StateDisabled                  XDis_helikopter_T
#define rtP                            helikopter_P
#define Parameters                     P_helikopter_T
#define rtDWork                        helikopter_DW
#define D_Work                         DW_helikopter_T
...
extern P_helikopter_T helikopter_P;

/* Block signals (auto storage) */
extern B_helikopter_T helikopter_B;

/* Continuous states (auto storage) */
extern X_helikopter_T helikopter_X;

/* Block states (auto storage) */
extern DW_helikopter_T helikopter_DW;

/* Model entry point functions */
extern void helikopter_initialize(void);
extern void helikopter_output(void);
extern void helikopter_update(void);
extern void helikopter_terminate(void);

/* Real-time Model object */
extern RT_MODEL_helikopter_T *const helikopter_M;
 ...
 *
 * '<Root>' : 'helikopter'
 * '<S1>'   : 'helikopter/Conversion'
 * '<S2>'   : 'helikopter/Degrees to Radians'
 * '<S3>'   : 'helikopter/Elevation controller'
 * '<S4>'   : 'helikopter/Helicopter_interface'
 * '<S5>'   : 'helikopter/Pitch controller'
 * '<S6>'   : 'helikopter/Helicopter_interface/Elevation rad to deg'
 * '<S7>'   : 'helikopter/Helicopter_interface/Elevation rate rad to deg'
 * '<S8>'   : 'helikopter/Helicopter_interface/Pitch rad to deg'
 * '<S9>'   : 'helikopter/Helicopter_interface/Pitch rate rad to deg'
 * '<S10>'  : 'helikopter/Helicopter_interface/Pitch rate rad to deg1'
 * '<S11>'  : 'helikopter/Helicopter_interface/Travel rad to deg'
 * '<S12>'  : 'helikopter/Helicopter_interface/Travel rate  rad to deg'
 */
